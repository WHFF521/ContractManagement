<template>
  <el-container style="height: 100%; background-color: #409eff20">
    <el-header>
      <el-row>
        <el-col :span="6">
          <div class="title" style="font-size: 20px;">已验收项目：区块链技术</div>
        </el-col>
    ...
    <el-main>
      <div class="main">
        ...
        <div>
          <h3>当前合同绩效评估：</h3>
          <h4>时间绩效：</h4> <el-progress :text-inside="true" :stroke-width="22" :percentage="90" status="success"></el-progress>
          <h4>成本绩效：</h4> <el-progress :text-inside="true" :stroke-width="22" :percentage="92" status="success"></el-progress>
          <h4>质量绩效：</h4> <el-progress :text-inside="true" :stroke-width="22" :percentage="95" status="success"></el-progress>
        </div>
      </div>
    </el-main>
  </el-container>
...
export default
{
    ...
    drawChart() {
      ...
      // 模拟柱状图数据
      const data = {
        labels: ['2022-10', '2022-11', '2022-12','2023-01','2023-02'],
        datasets: [
          {
            label: '预期值',
            data: [70, 85, 90,90,95],
