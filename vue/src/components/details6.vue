<template>
  <el-container style="height: 100%; background-color: #409eff20">
    <el-header>
      <el-row>
        <el-col :span="6">
          <div class="title" style="font-size: 20px;">已验收项目：人脸识别系统</div>
        </el-col>
    ...
    <el-main>
      <div class="main">
        ...
        <div>
          ...
          <h4>成本绩效：</h4> <el-progress :text-inside="true" :stroke-width="22" :percentage="85" ></el-progress>
          <h4>质量绩效：</h4> <el-progress :text-inside="true" :stroke-width="22" :percentage="73" ></el-progress>
        </div>
      </div>
    </el-main>
  </el-container>
  ...
  export default
  {
    ...
    restoreInputValue() {
      ...
      drawChart() {
        ...
        // 模拟柱状图数据
        const data = {
          labels: ['2022-02', '2022-03', '2022-04','2022-05'],
          datasets: [
            {
              label: '预期值',
              data: [70,80,80,75],
